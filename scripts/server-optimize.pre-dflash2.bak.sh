#!/usr/bin/env bash
# ==============================================================================
# Script: CooperxCompute High-Capacity & Speculative Acceleration Launcher
...
# Foundation: Qwen 3.8 / 2.5 27B Q8_0 + Qwen 2.5 Coder 0.5B Speculative Accelerator
# ==============================================================================
set -e
...
echo "Memulai CooperxCompute llama-server (4 Slots x 256K Context = 1M Tokens, 3x RTX 3090)..."
